class TradingStrategy:
    def __init__(self, initial_cash=100000, buy_amount_initial=10000, buy_amount_additional=20000, sell_threshold=1.3, stop_loss_threshold=0.8):
    ...
    def execute(self, data):
        ...
        for i in range(len(data)):
            ...
            if i == 0:
            ...
            elif current_price < initial_build_price * 0.8 and cash >= self.buy_amount_additional:
                ...
                num_shares = (holding * 0.2 // stock_unit) * stock_unit
                if num_shares > 0:
                    holding -= num_shares
                    cash += num_shares * current_price
            ...
            holding_amounts.append(holding * current_price)  # 新增持仓金额记录
